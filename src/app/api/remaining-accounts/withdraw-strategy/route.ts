...
const strategyHandlers = {
  drift: (vaultStrategyAuth: PublicKey): StrategyResponse => {
    ...
    return {
      ...
      remainingAccounts: [
        {
          pubkey: USDC_MARKETS_KEYS.drift.liquidityReserveAuth.toString(),
          isSigner: false,
          isWritable: true,
        },
        {
  ...
  kamino: (vaultStrategyAuth: PublicKey): StrategyResponse => {
    ...
    return {
      ...
      remainingAccounts: [
        {
          pubkey: USDC_MARKETS_KEYS.kamino.liquidityReserveAuth.toString(),
          isSigner: false,
          isWritable: true,
        },
        {
  ...
  solend: (vaultStrategyAuth: PublicKey): StrategyResponse => {
    ...
    return {
      ...
      remainingAccounts: [
        {
          pubkey: USDC_MARKETS_KEYS.solend.liquidityReserveAuth.toString(),
          isSigner: false,
          isWritable: true,
        },
        {
